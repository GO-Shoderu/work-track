...
export default async function CandidatesPage() {
  ...
  return <WorkspaceShell title={organisation.name} name={profile.full_name} context="Customer workspace" workspaceBasePath="/workspace" currentSection="candidates"><RecruitmentWorkspace view="candidates" /></WorkspaceShell>;
}
