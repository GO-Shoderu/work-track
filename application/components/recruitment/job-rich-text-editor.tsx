...
export function JobRichTextEditor({ onChange }: JobRichTextEditorProps) {
      ...
      content: [
        {
          ...
          content: [
            {
              type: "text",
              text: "Describe the role, responsibilities, requirements and what success looks like.",
            },
          ],
        },
      ],
    ...
    editorProps: {
      attributes: {
        class:
          ...
          "[&_h1]:mb-3 [&_h1]:mt-5 [&_h1]:text-2xl [&_h1]:font-semibold " +
          "[&_h2]:mb-2 [&_h2]:mt-5 [&_h2]:text-xl [&_h2]:font-semibold " +
          "[&_h3]:mb-2 [&_h3]:mt-4 [&_h3]:text-lg [&_h3]:font-semibold " +
          "[&_p]:my-2 [&_ul]:my-2 [&_ul]:list-disc [&_ul]:pl-6 " +
          "[&_ol]:my-2 [&_ol]:list-decimal [&_ol]:pl-6 " +
          "[&_li]:my-1 [&_a]:font-medium [&_a]:underline [&_a]:underline-offset-2",
      },
    },
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-border bg-white">
      <div className="flex flex-wrap gap-1.5 border-b border-border bg-[#f8f9fb] p-2">
